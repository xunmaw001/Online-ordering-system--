    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="口味" prop="kouwei">
          <el-select v-model="ruleForm.kouwei" placeholder="请选择口味">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="包装" prop="baozhuang">
          <el-select v-model="ruleForm.baozhuang" placeholder="请选择包装">
            <el-option
                v-for="(item,index) in baozhuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="包装" prop="baozhuang">
	      <el-input v-model="ruleForm.baozhuang"
                placeholder="包装" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
