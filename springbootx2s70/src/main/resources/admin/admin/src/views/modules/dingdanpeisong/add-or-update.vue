<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预计时长" prop="yujishizhang">
          <el-input v-model="ruleForm.yujishizhang" 
              placeholder="预计时长" clearable  :readonly="ro.yujishizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预计时长" prop="yujishizhang">
              <el-input v-model="ruleForm.yujishizhang" 
                placeholder="预计时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配送状态" prop="peisongzhuangtai">
          <el-select v-model="ruleForm.peisongzhuangtai" placeholder="请选择配送状态">
            <el-option
