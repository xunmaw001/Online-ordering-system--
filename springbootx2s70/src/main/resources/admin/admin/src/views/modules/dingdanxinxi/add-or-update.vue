<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="送餐地址" prop="songcandizhi">
          <el-input v-model="ruleForm.songcandizhi" 
              placeholder="送餐地址" clearable  :readonly="ro.songcandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="送餐地址" prop="songcandizhi">
              <el-input v-model="ruleForm.songcandizhi" 
                placeholder="送餐地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.songcandizhi!=''&&json.songcandizhi){
              		this.ruleForm.songcandizhi = json.songcandizhi
		}
